document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    es: {
      ...
      'hero.intro': '¡Hola! Soy',
      'hero.role': 'Desarrollador Web Freelance en Villavicencio, Colombia',
      'hero.description': 'Creo sitios web modernos, responsivos y optimizados que impulsan tu negocio. Especializado en diseño web, desarrollo front-end y soluciones personalizadas con HTML, CSS, JavaScript y WordPress, ayudo a empresas en Villavicencio y toda Colombia a destacar en línea. ¿Listo para llevar tu presencia digital al siguiente nivel?',
      'hero.cta': 'Explora Mis Proyectos',
      'about.title': 'Sobre Mí',
      'about.text1': 'Soy Cam, un desarrollador web front-end con base en Villavicencio, Colombia, apasionado por crear experiencias digitales únicas. Con más de X años de experiencia, diseño y desarrollo sitios web responsivos, rápidos y optimizados para SEO que ayudan a negocios locales a destacar en el mercado digital. Mi enfoque combina creatividad, tecnología moderna y un profundo entendimiento de las necesidades de mis clientes.',
      'about.text2': 'Trabajo con tecnologías de vanguardia para ofrecer soluciones personalizadas, desde páginas web corporativas hasta tiendas en línea. Mi objetivo es que cada proyecto no solo sea visualmente atractivo, sino también funcional y fácil de usar. Vivo en Villavicencio, pero atiendo clientes en toda Colombia, siempre con un enfoque en la calidad y la satisfacción del cliente.',
      'about.text3': 'Algunas de las tecnologías que domino:',
      'about.cta': '¿Quieres un sitio web que realmente conecte con tu audiencia? Contáctame hoy y hablemos de tu proyecto.',
      'services.title': 'Servicios de Desarrollo Web en Villavicencio',
      'services.design.title': 'Diseño Web Personalizado',
      'services.design.text': 'Creo sitios web únicos y responsivos que reflejan la identidad de tu marca. Utilizando HTML, CSS y JavaScript, diseño interfaces modernas y optimizadas para todos los dispositivos, perfectas para negocios en Villavicencio y más allá.',
      'services.development.title': 'Desarrollo Front-End',
      'services.development.text': 'Desarrollo interfaces interactivas y accesibles con tecnologías como React y JavaScript moderno. Mis soluciones garantizan una experiencia de usuario fluida, ideal para startups y empresas que buscan destacar en línea.',
      'services.wordpress.title': 'Sitios Web con WordPress',
      'services.wordpress.text': 'Construyo sitios web profesionales con WordPress, optimizados con Yoast SEO y personalizados con Elementor. Desde blogs hasta tiendas en línea, ofrezco soluciones escalables para empresas en Colombia.',
      'services.seo.title': 'Optimización SEO',
      'services.seo.text': 'Mejoro la visibilidad de tu sitio web en Google con estrategias de SEO local y técnico. Desde la optimización de palabras clave hasta la velocidad de carga, aseguro que tu negocio en Villavicencio sea encontrado fácilmente.',
      'services.cta': '¿Listo para transformar tu presencia digital? Solicita una Cotización',
      'projects.title': 'Proyectos de Desarrollo Web',
      'projects.portfolio.title': 'Portafolio Personal',
      'projects.portfolio.description': 'Diseñé y desarrollé mi propio sitio web como portafolio, un proyecto responsivo que muestra mis habilidades en HTML, CSS y JavaScript. Este sitio está optimizado para SEO y ofrece una experiencia de usuario fluida, ideal para destacar en Villavicencio.',
      'projects.wonder.title': 'Wonder Nails - Spa',
      'projects.wonder.description': 'Desarrollé un sitio web moderno y responsivo para Wonder Nails Spa en Villavicencio. Con un diseño atractivo, animaciones suaves y una API de reservas integrada, este proyecto mejora la presencia digital del negocio y facilita la interacción con los clientes.',
      'projects.bloom.title': 'Bloom Luxury - Spa',
      'projects.bloom.description': 'Creé una landing page elegante y responsiva para Bloom Luxury Spa en Villavicencio. Este proyecto destaca por su diseño limpio, navegación intuitiva y optimización para dispositivos móviles, ayudando al spa a atraer más clientes locales.',
      'projects.live': 'Ver en Vivo',
      'contact.title': 'Contáctame Hoy',
      'contact.text': '¿Buscas un desarrollador web en Villavicencio para crear o mejorar tu sitio web? Estoy aquí para ayudarte. Ofrezco soluciones personalizadas de diseño y desarrollo web que impulsan tu negocio. Escríbeme por correo, WhatsApp o llámame, y empecemos a trabajar en tu proyecto. ¡Responderé lo antes posible!',
      ...
      'contact.form.success': '¡Mensaje enviado con éxito! Te contactaré pronto.',
