...
export const metadata: Metadata = {
  title: 'Portafolio - Web Dev by Cam',
  description: 'Explora nuestros proyectos de desarrollo web y software.',
};
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="container mx-auto p-4 flex-grow">
        <section className="py-16">
          <h2 className="text-4xl font-bold mb-4 text-mystical-gold text-center">Nuestro Portafolio</h2>
          <p className="text-neutral-gray max-w-2xl mx-auto">
            Pronto publicaremos nuestros proyectos destacados. ¡Contáctanos para ver ejemplos!
          </p>
        </section>
      </main>
