...
export const metadata: Metadata = {
  title: 'Blog - Web Dev by Cam',
  description: 'Artículos sobre desarrollo web, WordPress, SEO y más.',
};
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="container mx-auto p-4 flex-grow">
        <section className="py-16">
          <h2 className="text-4xl font-bold mb-4 text-mystical-gold text-center">Nuestro Blog</h2>
          <p className="text-neutral-gray max-w-2xl mx-auto">
            Próximamente publicaremos artículos sobre desarrollo web, SEO y tecnología. ¡Mantente atento!
          </p>
        </section>
      </main>
